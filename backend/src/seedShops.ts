...
// Run: npx ts-node --transpile-only src/seedShops.ts

import { PrismaClient } from "@prisma/client";
const prisma = new PrismaClient();

async function main() {
  console.log("Seeding 63 shops from September 2024 sales data...");
  ...
  const shops = [
    ...
    { code: "KBP_JUJAFARMEVANS", name: "JUJA FARM-evans", unit: "KBP" },
    { code: "KBP_JUJAGATECJIMMY", name: "JUJA GATE C-jimmy", unit: "KBP" },
    { code: "KBP_LAICAGACHORORONJ", name: "LAICA GACHORORO-njau", unit: "KBP" },
    ...
    { code: "OTHERS_GRANDTOTAL", name: "Grand Total", unit: "OTHERS" },
  ];
  ...
  console.log(`Done! ${created} shops seeded.`);
}
